...
resource "aws_vpc" "main" {
  ...
  enable_dns_support   = true   # required for MSK to resolve broker hostnames
...
resource "aws_subnet" "public" {
  ...
  map_public_ip_on_launch = true  # bastion needs a public IP automatically
...
# --- Private Subnets (MSK + RDS live here) ---
